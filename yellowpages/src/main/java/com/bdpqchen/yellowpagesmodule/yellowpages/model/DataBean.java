...
public class DataBean {
    ...
    public static class CategoryListBean {
        /**
         * category_name : 校级
         * department_list : [{"department_name":"学工部","unit_list":[{"item_name":"学工部部长室","item_phone":"27403289"},{"item_name":"副部长","item_phone":"27403289"}]},{"department_name":"宣传部","department_list":[{"item_name":"宣传部校报","item_phone":"string"},{"item_name":"宣传部广播站","item_phone":"27407083"}]}]
         */

        private String category_name;
        private List<DepartmentListBeanX> department_list;
        ...
        public List<DepartmentListBeanX> getDepartment_list() {
            return department_list;
        }

        public void setDepartment_list(List<DepartmentListBeanX> department_list) {
            this.department_list = department_list;
        }

        public static class DepartmentListBeanX {
            /**
             * department_name : 学工部
             * unit_list : [{"item_name":"学工部部长室","item_phone":"27403289"},{"item_name":"副部长","item_phone":"27403289"}]
             * department_list : [{"item_name":"宣传部校报","item_phone":"string"},{"item_name":"宣传部广播站","item_phone":"27407083"}]
             */
